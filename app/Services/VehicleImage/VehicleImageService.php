...
class VehicleImageService extends BaseService {
	...
	public function store( array $data ) {
		return $this->saveVehicleImage( $data );
	}
	...
	public function update( $id, array $data ) {
		return $this->saveVehicleImage( $data, $id );
	}
	...
	public function destroy( $id ) {
		return VehicleImage::find( $id )->delete();
	}
	 ...
	 * @return mixed
	 */
	private function saveVehicleImage( $data, $id = null ) {
		$location = VehicleImage::findOrNew( $id );
		$location->fill( $data );
		$location->save();
