...
namespace App\Services\VehicleFeature;
...
class VehicleFeatureService extends BaseService {
	...
	public function store( array $data ) {
		return $this->saveVehicleFeature( $data );
	}
	...
	public function update( $id, array $data ) {
		return $this->saveVehicleFeature( $data, $id );
	}
	...
	public function destroy( $id ) {
		return VehicleFeature::find( $id )->delete();
	}
	 ...
	 * @return mixed
	 */
	private function saveVehicleFeature( $data, $id = null ) {
		$location = VehicleFeature::findOrNew( $id );
		$location->fill( $data );
		$location->save();
