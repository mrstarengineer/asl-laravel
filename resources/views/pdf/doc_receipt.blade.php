...
<div>
    ...
    <div id="modal_content">
        <div class="cond_here">
            <div id="page_border" style="padding:11px;">
                ...
                <table width="100%" contenteditable="true">
                    ...
                    <tr>
                        <td colspan="3" rowspan="2" width="50%" valign="top" style="height:100px;">
                            ...
                            <br>
{{--                            {{ data_get($export, 'customer.company_name') . ' ' . data_get($export, 'customer.address_line_1') }}--}}
                            <br>
{{--                            {{ data_get($export, 'customer.state.name') }}--}}
                            <br>
                            {{ data_get($export, 'customer.zip_code') }}
                        </td>
                        ...
                        <td colspan="2">
                            ...
                            <table id="cars_no_border">
                                ...
                                <tr class="table_td_no_border">
                                    <td colspan="6">{{ trans('exports.container_types.'.$export->container_type) }}</td>
                                </tr>
                                ...
                                @foreach ( $export->vehicles as $vehicle_detail )
                                    ...
                                    <tr class="table_td_no_border" style="font-size: 11px">
                                        <td align="left">{{ $i++ }}</td>
                                        <td align="left">{{ $vehicle_detail->year }}</td>
                                        <td align="left">{{ $vehicle_detail->make }}</td>
                                        <td align="left">{{ $vehicle_detail->model }}</td>
                                        <td align="left">{{ $vehicle_detail->vin }}</td>
                                        <td align="left">Wt:{{ $vehicle_detail->weight }}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
